...
class _LoginScreenState extends State<LoginScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          _buildOrb(top: -100, left: -100, size: 400, opacity: 0.04),
          _buildOrb(bottom: -50, right: -50, size: 280, opacity: 0.03),
          // Content
          SafeArea(
            child: Center(
              child: Padding(
  ...
  Widget _buildOrb({double? top, double? left, double? bottom, double? right, required double size, required double opacity}) {
    return Positioned(
